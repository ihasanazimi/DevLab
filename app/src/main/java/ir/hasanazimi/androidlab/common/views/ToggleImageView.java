package ir.hasanazimi.androidlab.common.views;
...
public class ToggleImageView extends AppCompatImageView implements View.OnClickListener {
    ...
    public ToggleImageView(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, ir.hasanazimi.androidlab.R.styleable.ToggleImageView, 0, 0);

        try {
            mCheckedRes = typedArray.getResourceId(ir.hasanazimi.androidlab.R.styleable.ToggleImageView_src_checked, 0);
            mUncheckedRes = typedArray.getResourceId(ir.hasanazimi.androidlab.R.styleable.ToggleImageView_src_unchecked, 0);
