package ir.hasanazimi.androidlab.common.date_time
 ...
 * @version 1.0
 */
class PersianDateParser(dateString: String) {
    ...
    val persianDate: HsnPersianCalendar
        /**
